                        ...
                        <div class="about-contact-info clearfix">
                          <div class="address-info">
                            ...
                            <div class="info-content">
                              <p>Plot No. 177, Sri Vani Nilayam, Sardar Patel Nagar, Opp Nizampet X-Road, Hyderabad,Telangana - 500072.</p>
                            </div>
                          </div>
                          ...
                          <div class="email-info">
                            ...
                            <div class="info-content">
                              <p>admin@pracha.com</p>
                              <p>support@pracha.com</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="ft-fixed-area">
                    <div class="reservation-box">
                      <div class="reservation-wrap">
                        ...
                        <p class="res-number">(040)-48541273</p>
                      </div>
                    </div>
                  </div>
                </div>
