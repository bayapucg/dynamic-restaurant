                ...
                <div class="content container-fluid">	
					<div class="row">
						...
						<div class="col-xs-8 text-right m-b-30">
							<a href="gallery.php" class="btn btn-primary pull-right rounded" ><i class="fa fa-plus"></i> Add Gallery</a>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right">
												...
												<a href="edit-gallery.php"><button type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button></a>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td class="text-right">
												...
												<button type="button" class="btn btn-danger">Delete</button>
												<a href="gallery.php"><button type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button></a>
