						...
						<tbody>
							<tr id='addr0'>
								<td>
									...
									<td>
										<input type="date" name='name0'  placeholder='Enter date' class="form-control" value="2013-01-08"/>
										

									</td>
									<td>
										<input type="text" name='name0'  placeholder='Enter procedure' class="form-control"value="making of pizza"/>
									</td>
								</tr>
								<tr id='addr1'></tr>
							</tbody>
